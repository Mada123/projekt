...
<div class="container">
 ...
 <h1>Wypo¿yczalnia filmów  <small>  Najlepsze filmy nie tylko na d³ugie wieczory</small></h1>
 </div>
</div>
 ...
 <li class="active"><a href="index.php">Strona g³ówna</a></li>
 ...
 <li>
  ...
  <?php
	...
	elseif (isset($_POST['login']) && isset($_POST['password']) && $_SESSION['auth'] == FALSE) {
		...
		$sql = mysql_num_rows(mysql_query("SELECT * FROM `user` WHERE `login` = '$login' AND `password` = '$password'"));
			...
			if ($sql == 1) {
				...
				echo '<p style="padding-top:10px";><strong>Proszê czekaæ...</strong><br />trwa logowanie i wczytywanie danych</p>';
			}
            ...
            // je¿eli zapytanie nie zwróci 1, to wyœwietlam komunikat o b³êdzie podczas logowania
				...
				echo '<a href="index.php">Wróæ do formularza</a></p>';
			}
		}
	...
	if ($_SESSION['auth'] == TRUE) {
       echo '<a href="index.php?logout">Wyloguj siê</a>';
  }
  else {
          echo '<meta URL=index.php">';
       //   echo '<p style="padding-top:10px;color:white";><strong>Próba nieautoryzowanego dostêpu...</strong><br />trwa przenoszenie do formularza logowania</p>';
  }
  ...
  // wyloguj siê
    if  ($_SESSION['auth'] == TRUE && isset($_GET['logout'])) {
		...
		$_SESSION['auth'] = FALSE;
		echo '<meta http-equiv="refresh" content="1; URL=index.php">';
		echo '<p style="padding-top:10px"><strong>Proszê czekaæ...</strong><br />trwa wylogowywanie</p>';
	}
  ?>
  </li>
